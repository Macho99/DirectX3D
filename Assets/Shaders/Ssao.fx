...
float4 PS(VertexOut pin, uniform int gSampleCount) : SV_Target
{
    ...
    float4 normalDepth = NormalMap.SampleLevel(samNormalDepth, pin.Tex, 0.0f);
    ...
    float3 randVec = 2.0f * RandomMap.SampleLevel(samRandomVec, 4.0f * (pin.Tex.x + pin.Tex.y), 0.0f).rgb - 1.0f;
    ...
    for (int i = 0; i < gSampleCount; ++i)
    {
        ...
        float rz = NormalMap.SampleLevel(samNormalDepth, projQ.xy, 0.0f).a;
